...
with footer_col2:
    ...
    st.markdown(f"<p style='text-align:center;color:#64748b;'text-decoration: none;'>📧 <a href='mailto:io7hub@naver.com'>io7hub@naver.com</a> | <a href='{url}'>🌐 {url}</a></p>", unsafe_allow_html=True)
