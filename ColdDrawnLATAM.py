...
with footer_col2:
    ...
    st.markdown(f"<p style='text-align:center;color:#64748b;'>📧 <a href='mailto:io7hub@naver.com'>io7hub@naver.com</a> | <a href='{url}' style='text-decoration: none;'>🌐 {url}</a></p>", unsafe_allow_html=True)
